...
*** Fifth test: Implementing ::before pseudo-selector
...
attribute, expect it as a parameter of the constructor, and make sure *CssActionFactory* pass the *Css* instance when
...
Second, in *InsertBeforeCssAction* we are searching the "content" property to
retrieve the text to prepend. It's very likely we'll need this logic 
