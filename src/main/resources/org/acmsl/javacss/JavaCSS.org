...
- .packageDeclaration .packageModifier:child , .packageDeclaration .packageModifier:last-child : To overwrite the "separator" directive.
- .packageDeclaration .packageModifier + \s+
