...
modeling the template itself as a DOM or AST, and filtering certain nodes or properties of such tree. Before worrying
about that, we need to implement a DSL for the new CSS-like grammar.
