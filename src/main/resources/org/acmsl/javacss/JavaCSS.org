...
a MethodDeclaration by checking if its associated "payload" is of type Java8Parser.MethodDeclarationContext.

However, ANTLR4 deals with our use case explicitly, in its [[https://theantlrguy.atlassian.net/wiki/display/ANTLR4/Parse%2BTree%2BMatching%2Band%2BXPath][Parse Tree Matching and XPath]] article.
