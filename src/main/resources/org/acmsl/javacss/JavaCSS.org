...
Next, we want to define how to retrieve the properties associated to a selector. It's easy to make the test generic and don't assume a fixed number of blocks, at the cost of making
...
Now some tests pass, some doesn't. For a count of 8 it doesn't work. Let's force that test to dig into the issue. The input we are parsing is:
...
.packageDeclaration #identifier2::before {
    content: "  ";
}

.packageDeclaration #identifier3::before {
    content: "  ";
}

.packageDeclaration #identifier4::before {
    content: "  ";
}

.packageDeclaration #identifier5::before {
    content: "  ";
}

.packageDeclaration #identifier6::before {
    content: "  ";
}

.packageDeclaration #identifier7::before {
    content: "  ";
}
